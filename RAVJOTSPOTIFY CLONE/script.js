...
// Function to play a song with the given index
...
// Function to update all play icons to show play state
const makeAllPlays = () => {
...
// Handle play/pause click for master control
...
// Individual song play/pause button
Array.from(document.getElementsByClassName('songItemPlay')).forEach((element) => {
    element.addEventListener('click', (e) => {
        if (audioElement.paused || songIndex !== parseInt(e.target.id)) {
            ...
            // Pause the song if the clicked icon is the one currently playing
            pauseSong();
        }
    });
});
